...
const { reviewsRequested, reviewsReceived, reviewsRequestFailed, reviewCreated, reviewRemoved, reviewUpdated } = actions;
...
export const loadReviewsList = () => async (dispatch: any) => {
...
export const getReviewsByIds = (reviewsIds: string[]) => (state: any) => {
...
export const getReviewsByRoomId = (roomId: string) => (state: any) => {
  if (state.reviews.entities) {
...
export const getReviews = () => (state: any) => state.reviews.entities;
export const getReviewsLoadingStatus = () => (state: any) => state.reviews.isLoading;
